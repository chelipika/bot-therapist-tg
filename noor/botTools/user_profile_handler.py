...
from config import CHANNEL_LINK, TOKEN
...
@UserProfileRouter.callback_query(F.data == "profile")
...
@UserProfileRouter.callback_query(F.data == "show_users_profliee")
...
@UserProfileRouter.callback_query(F.data == "create_update_profile")
...
@UserProfileRouter.message(Command("reg"))
...
@UserProfileRouter.message(Reg.name)
...
@UserProfileRouter.message(Reg.Experience)
...
@UserProfileRouter.message(Reg.Approach)
...
@UserProfileRouter.message(Reg.Mission)
...
@UserProfileRouter.message(Reg.Commitment)
...
@UserProfileRouter.message(Reg.CallToAction)
...
@UserProfileRouter.message(Reg.ai_name)
